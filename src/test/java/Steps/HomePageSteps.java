...
public void setup() throws IOException {
    ...
    @Given("^User is on the Volkswagen Financial Service Home Page on URL \"(.*?)\"$")
    public void user_is_on_the_Volkswagen_Financial_Service_Home_Page_on_URL(String arg1) throws Throwable {
