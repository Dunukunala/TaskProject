    ...
    public void initialize() throws IOException {
        ...
        if (driver == null) {
            ...
            if (CONFIG.getProperty("browser").equals("firefox")) {
                 ...
                 System.setProperty("webdriver.gecko.driver", "C:\\Users\\Honey\\Desktop\\geckodriver.exe");
                driver = new FirefoxDriver();

            } else if (CONFIG.getProperty("browser").equals("chrome")) {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\Honey\\Desktop\\chromedriver.exe");
